<template>
    ...
    <div class="q-pa-md">
        <q-table flat bordered ref="tableRef" :class="tableClass" :loading="loading" tabindex="0" title="Users"
            :rows="users" :columns="columns" row-key="id" :selected-rows-label="getSelectedString" selection="multiple"
...
import { Account, AccountCreate, AccountUpdate, Role, Major } from '../../../services/api'
