...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  opencourse = {
     ...
     *
     * @tags opencourse
     * @name GetopencourseUserOpencourseIdUsersGet
     * @summary Getopencourse User
     * @request GET:/opencourse/{id}/users
     * @secure
     */
    getopencourseUserOpencourseIdUsersGet: (id: number, params: RequestParams = {}) =>
      this.request<Enrollment[], HTTPValidationError>({
        path: `/opencourse/${id}/users`,
        method: 'GET',
        secure: true,
        format: 'json',
        ...params,
     ...
     *
     * @tags opencourse
     * @name GetopencourseTeacherOpencourseTeacherGet
     * @summary Getopencourse Teacher
     * @request GET:/opencourse/teacher
     * @secure
     */
    getopencourseTeacherOpencourseTeacherGet: (params: RequestParams = {}) =>
      this.request<Opencourse[], any>({
        path: `/opencourse/teacher`,
        method: 'GET',
        secure: true,
        format: 'json',
        ...params,
     ...
     *
     * @tags opencourse
     * @name IncreasedopencourseOpencourseIdIncreasedPatch
     * @summary Increasedopencourse
     * @request PATCH:/opencourse/{id}/increased
     * @secure
     */
    increasedopencourseOpencourseIdIncreasedPatch: (id: number, params: RequestParams = {}) =>
      this.request<Opencourse, HTTPValidationError>({
        path: `/opencourse/${id}/increased`,
        method: 'PATCH',
        secure: true,
        format: 'json',
        ...params,
     ...
     *
     * @tags opencourse
     * @name DecreasedopencourseOpencourseIdDecreasedPatch
     * @summary Decreasedopencourse
     * @request PATCH:/opencourse/{id}/decreased
     * @secure
     */
    decreasedopencourseOpencourseIdDecreasedPatch: (id: number, params: RequestParams = {}) =>
      this.request<Opencourse, HTTPValidationError>({
        path: `/opencourse/${id}/decreased`,
        method: 'PATCH',
        secure: true,
        format: 'json',
        ...params,
  ...
  enrollment = {
     ...
     *
     * @tags enrollment
     * @name GetenrollmentStudentEnrollmentStudentGet
     * @summary Getenrollment Student
     * @request GET:/enrollment/student
     * @secure
     */
    getenrollmentStudentEnrollmentStudentGet: (params: RequestParams = {}) =>
      this.request<Enrollment[], any>({
